package com.mcxtzhang.databindingutils.recyclerview.m;

import android.databinding.Bindable;

import com.mcxtzhang.databindinglib.mul.IBaseMulInterface;
import com.mcxtzhang.databindingutils.R;
import com.mcxtzhang.databindingutils.recyclerview.multype.MulTypeBean;
...
public class FirstBindingBean extends MulTypeBean implements IBaseMulInterface {
    ...
    public void setUrl(String url) {
        this.url = url;
        notifyPropertyChanged(com.mcxtzhang.databindingutils.BR.url);
    }
    ...
    public void setName(String name) {
        this.name = name;
        notifyPropertyChanged(com.mcxtzhang.databindingutils.BR.name);
    }
